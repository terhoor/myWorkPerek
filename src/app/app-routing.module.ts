...
const appRoutes: Routes = [
  {path: '', component: MainLayoutComponent, children: [
    ...
    {path: 'code', component: CodeAccessPageComponent, canActivate: [AccessGuard]},
    {path: 'registration', component: RegistrationPageComponent, canActivate: [AccessGuard]},
    {path: 'register-success', component: RegistrationAccessPageComponent, canActivate: [AccessGuard]},
  ]},
